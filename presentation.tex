...
\end{center}
	...
	\section{Exceptions}
	{
	\usebackgroundtemplate{\includegraphics[width=\paperwidth]{elephant.png}}
	...
	\begin{frame}[fragile]{Anti Dead lock}
		\lstinputlisting[firstline=1,lastline=5,language=D,basicstyle=\small\ttfamily]{deadlock.d}
		\pause
		\lstinputlisting[firstnumber=6,firstline=6,lastline=13,language=D,basicstyle=\small\ttfamily]{deadlock.d}
	\end{frame}
